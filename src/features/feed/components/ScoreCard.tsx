...
const PREVIEW = {
  ...
  sportIconMarginRight: 4,
  sportIconMarginLeft: 4,
  singlesRowGap: 2,
  matchTypeBadgeMinWidth: 28,
...
const ScoreCard: React.FC<ScoreCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <LinearGradient
        colors={[
          `rgba(${parseInt(sportColors.background.slice(1, 3), 16)}, ${parseInt(sportColors.header.slice(3, 5), 16)}, ${parseInt(sportColors.background.slice(5, 7), 16)}, 0.08)`,
          "#FFFFFF",
        ]}
        start={{ x: 0, y: 0 }}
        end={{ x: 0, y: 1 }}
        ...
        <View style={styles.headerTopRow}>
          <View style={styles.headerLeft}>
            <View
              style={[
                styles.sportIcon,
                isPreview && { marginRight: PREVIEW.sportIconMarginRight  , marginLeft: PREVIEW.sportIconMarginLeft, },
              ]}
            >
              <SportIcon
                sport={match.sport ?? ""}
                size={isPreview ? PREVIEW.iconSize : 68}
